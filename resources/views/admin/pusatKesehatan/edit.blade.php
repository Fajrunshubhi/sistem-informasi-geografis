...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><a href="/admin/dashboard" class="text-muted fw-light">SIG | Pemetaan Sebaran
            Kesehatan /</a> Pusat Kesehatan
    </h4>
    <div class="card">
        <div class="d-flex justify-content-between">
            <h5 class="card-header d-inline">Edit Data Pusat Kesehatan</h5>
        </div>
        <div class="row">
            <div class="col-xl">
                <div class="card mb-4">
                    <div class="card-body">
                        <form method="POST" action="/admin/data/pusat-kesehatan/{{ $pusatKesehatan->id }}"
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6" style="margin-top: 3px">
                                    ...
                                    <select class="form-control select-desa @error('desa_id') is-invalid @enderror"
                                        value="{{ old('desa_id', $pusatKesehatan->desa_id) }}" id="select-nama-desa"
                                        name="desa_id" required>
                                        <option>Pilih desa</option>
                                        @foreach ($desa as $data)
                                        @if (old('desa_id', $pusatKesehatan->desa_id) == $data->id)
                                ...
                                <div class="col-md-6">
                                    <label class="form-label" for="nama-pusat-kesehatan">Nama Pusat Kesehatan</label>
                                    <input type="text" name="nama_pusat_kesehatan"
                                        class="form-control @error('nama_pusat_kesehatan') is-invalid @enderror"
                                        id="nama-pusat-kesehatan"
                                        value="{{ old('nama_pusat_kesehatan', $pusatKesehatan->nama_pusat_kesehatan) }}"
                                        placeholder="Pusat Kesehatan" required />
                                    @error ('nama_pusat_kesehatan')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                                    @enderror
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="no_tlpn" id="no_tlpn"
                                        ...
                                        value="{{ old('no_tlpn', $pusatKesehatan->no_tlpn) }}"
                                ...
                                <div class="col-md-6">
                                    <div class="row ">
                                        <div class="col-md-6">
                                            ...
                                            <input type="hidden" name="oldImage" value="{{ $pusatKesehatan->gambar }}">

                                            <input class="form-control @error('gambar') is-invalid @enderror"
                                                name="gambar" type="file" id="gambar" name="gambar"
                                                onchange="previewImage()"
                                                value="{{ old('gambar', $pusatKesehatan->gambar) }}" />
                                            @error ('gambar')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <img src="{{ asset('storage/'.$pusatKesehatan->gambar) }}" alt=""
                            ...
                            <div class="row mb-3">
                                <div class="col-12">
                                    ...
                                    <textarea id="alamat" name="alamat"
                                        ...
                                        required>{{ old('alamat', $pusatKesehatan->alamat) }}</textarea>
                                    @error ('alamat')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control @error('latitude') is-invalid @enderror" type="text"
                                        value="{{ old('latitude', $pusatKesehatan->latitude) }}" readonly required
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control @error('longitude') is-invalid @enderror" type="text"
                                        ...
                                        value="{{ old('longitude', $pusatKesehatan->longitude) }}" />
                                    @error ('longitude')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="row mb-3 mt-5">
                                <div class="col-12 d-flex justify-content-between">
                                    ...
                                    <a class="btn btn-danger" href="/admin/data/pusat-kesehatan">Batal</a>
                                </div>
                            </div>
                        </form>
                    </div>
