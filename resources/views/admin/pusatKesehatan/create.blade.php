...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="card">
        <div class="d-flex justify-content-between">
            <h5 class="card-header d-inline">Tambah Data Pusat Kesehatan</h5>
        </div>
        <div class="row">
            <div class="col-xl">
                <div class="card mb-4">
                    <div class="card-body">
                        <form method="POST" action="/admin/data/pusat-kesehatan" enctype="multipart/form-data">
                            @csrf
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="nama_pusat_kesehatan"
                                        ...
                                        id="nama-pusat-kesehatan" value="{{ old('nama_pusat_kesehatan') }}"
                                    ...
                                    <div class="row ">
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control @error('gambar') is-invalid @enderror"
                                                name="gambar" type="file" id="gambar" onchange="previewImage()"
