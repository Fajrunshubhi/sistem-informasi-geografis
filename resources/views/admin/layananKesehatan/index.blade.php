                        ...
                        <td>
                            ...
                            <div class="container-aksi align-items-center">
                                ...
                                <form id="delete-form-{{ $data->id }}"
                                    action="/admin/data/layanan-kesehatan/{{ $data->id }}" method="POST">
                                    @method('delete')
                                    @csrf
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="viewModalLabel{{ $data->id }}">Detail Layanan Kesehatan
                                    </h5>
                                ...
                                <div class="modal-body">
                                    <div class="container">
                                        ...
                                        <div class="row mb-2">
                                            <div class="col-6"><strong>Nama Layanan</strong></div>
                                            <div class="col-6">: {{ $data->nama_layanan }}</div>
                                        </div>

                                        <div class="row mb-2">
                                            <div class="col-6"><strong>Waktu Layanan</strong></div>
                                            <div class="col-6">: {{ $hari }}, {{ $tanggalFormatted }} {{ $bulan }} {{
                                                $tahun }} <br> - Jam: {{ $jam }} s/d selesai</div>
                                        </div>
                                            ...
                                            <div class="col-12">
                                                <div class="w-100 d-flex justify-content-center">
                                                    <img src="{{ asset('storage/'.$data->gambar) }}"
                                                        alt="{{ $data->nama_layanan }}" class="img-fluid w-75">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="container-aksi d-flex">
                                                <a href="/admin/data/layanan-kesehatan/{{ $data->id }}/edit"
                                                    class="badge bg-warning d-block me-2"><i
                                                        class="bi bi-pencil-square me-1"></i>Edit</a>
                                                <form id="delete-form-{{ $data->id }}"
                                                    action="/admin/data/layanan-kesehatan/{{ $data->id }}"
                                                    method="POST">
                                                    @method('delete')
                                                    @csrf
                                                    <button type="button" class="badge bg-danger border-0 w-100"
