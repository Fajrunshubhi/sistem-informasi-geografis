...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><a href="/admin/dashboard" class="text-muted fw-light">SIG | Pemetaan Sebaran
            Kesehatan /</a> Layanan Kesehatan
    </h4>
    <div class="card">
        <div class="d-flex justify-content-between">
            <h5 class="card-header d-inline">Tambah Data Layanan Kesehatan</h5>
        </div>
        <div class="row">
            <div class="col-xl">
                <div class="card mb-4">
                    <div class="card-body">
                        <form method="POST" action="/admin/data/layanan-kesehatan" enctype="multipart/form-data">
                            @csrf
                            <div class="row mb-3">
                                <div class="col-12">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6" style="margin-top: 3px">
                                    ...
                                    <input type="text"
                                        ...
                                        id="nama-layanan-kesehatan" value="{{ old('nama_layanan') }}"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control @error('waktu_layanan') is-invalid @enderror"
                                        type="datetime-local" value="{{ old('waktu_layanan') }}" id="waktu_layanan"
                                        name="waktu_layanan" required />
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-md-6">
