    ...
    <div class="card">
        ...
        <div class="row">
            <div class="col-xl">
                <div class="card mb-4">
                    <div class="card-body">
                        <form method="POST" action="/admin/pasien/{{ $pasien->id }}">
                            @method('put')
                            @csrf
                            <div class="row mb-3">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4" style="margin-top: 3px">
                                    ...
                                    <select class="form-control select @error('desa_id') is-invalid @enderror"
                                        ...
                                        <option value="{{ $data->id }}" {{ old('desa_id', $pasien->desa_id
                                            )==$data->id ? 'selected' :
                            ...
                            <div class="row mb-3">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="no_tlpn" id="no-hp"
                                        ...
                                        value="{{ old('no_tlpn', $pasien->no_tlpn) }}" placeholder="08xxxxxxxxxx"
                                        required />
                                    @error ('no_tlpn')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                ...
                                <div class="col-md-4" style="margin-top: 3px">
                                    ...
                                    <select class="form-control select @error('jenis_kelamin') is-invalid @enderror"
                                        ...
                                        <option value="Laki-laki" {{ old('jenis_kelamin', $pasien->
                                            jenis_kelamin)=='Laki-laki'
                                            ? 'selected' : ''
                                            }}>Laki-laki</option>
                                        <option value="Perempuan" {{ old('jenis_kelamin',$pasien->
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control @error('umur') is-invalid @enderror" min="0" max="100"
                                        type="number" value="{{ old('umur', $pasien->umur) }}" id="umur"
                                        placeholder="Umur" name="umur" required />
                                    @error ('umur')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
