    ...
    <div class="card">
        ...
        <div class="row">
            <div class="col-xl">
                <div class="card mb-4">
                    <div class="card-body">
                        <form method="POST" action="/admin/penyakit">
                            @csrf
                            <div class="row mb-3">
                                <div class="col-md-8">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('nama_penyakit') }}" id="nama-penyakit" name="nama_penyakit"
                                        placeholder="Nama penyakit" required autofocus />
                                    @error ('nama_penyakit')
                                ...
                                <div class="col-md-4" style="margin-top: 3px">
                                    ...
                                    <select class="form-control select @error('kategori') is-invalid @enderror"
                                        name="kategori" required id="select-kategori-penyakit">
                                        <option value="">Pilih Kategori</option>
                                        <option value="Menular" {{ old('kategori')=='Menular' ? 'selected' : '' }}>
                                            Menular</option>
                                        <option value="Tidak Menular" {{ old('kategori')=='Tidak Menular' ? 'selected'
                                            : '' }}>
                            ...
                            <div class="row mb-3">
                                <div class="col-12">
                                    ...
                                    <p class="text-danger">{{ $errors->first('gejala') }}</p>
                                    @endif
