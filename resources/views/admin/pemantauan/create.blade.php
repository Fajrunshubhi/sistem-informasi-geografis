...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="card">
        <div class="d-flex justify-content-between">
            <h5 class="card-header d-inline">Tambah Data Pemantauan Penyakit</h5>
        </div>
        <div class="row">
            <div class="col-xl">
                <div class="card mb-4">
                    <div class="card-body">
                        <form method="POST" action="/admin/pemantauan">
                            @csrf
                            <div class="row mb-3">
                                <div class="col-md-6" style="margin-top: 3px">
                                    ...
                                    <select
                                        ...
                                        <option value="{{ $data->id }}" {{ old('kondisi_kesehatan_id')==$data->id ?
                                            'selected' :
                                            ''}}>{{ $data->id }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6" style="margin-top: 3px">
                                    ...
                                    <select class="form-control select @error('tingkat_keparahan') is-invalid @enderror"
                                        ...
                                        <option value="Kritis (Critical)">Kritis (Critical)</option>
                                    </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control @error('waktu_pemantauan') is-invalid @enderror"
                                        ...
                                        value="{{ old('waktu_pemantauan') }}" id="waktu-pemantauan" required />
