...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="card">
        <div class="d-flex justify-content-between">
            <h5 class="card-header d-inline">Tambah Data Laporan Kesehatan</h5>
        </div>
        <div class="row">
            <div class="col-xl">
                <div class="card mb-4">
                    <div class="card-body">
                        <form method="POST" action="/admin/laporan-kesehatan" enctype="multipart/form-data">
                            @csrf
                            <div class="row mb-3">
                                <div class="col-12">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-8">
                                    ...
                                    <input type="text" id="judul-laporan"
                                        ...
                                        value="{{ old('judul_laporan') }}" name="judul_laporan" placeholder="Judul"
                                        required />
                                    @error ('judul_laporan')
                                    <div class="invalid-feedback">
                                        {{ $message }}
